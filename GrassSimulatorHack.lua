...
local Window = Library.CreateLib("GrassSimulatorHack", "RJTheme6")
local Tab = Window:NewTab("AutoFarm")
local Section = Tab:NewSection("AutoFarmGrass")
Section:NewToggle("AutoFarmGrass", "i am gay", function(state)
    if state then
       while wait() do
...
local A_1 = "1"
local Event = game:GetService("ReplicatedStorage").Remotes.Game.ClientMowGrass
...
local Tab = Window:NewTab("Abiliti")
...
Section:NewSlider("JumpPower", "SliderInfo", 500, 1, function(s) -- 500 (Макс. значение) | 0 (Мин. значение)
    game:GetService("Workspace")["Sosatel_337"].Humanoid.JumpPower = s
end)
